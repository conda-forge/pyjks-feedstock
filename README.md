About pyjks-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyjks-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2345&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyjks-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyjks` can be installed with `conda`:
...
It is possible to list all of the versions of `pyjks` available on your platform with `conda`:
...
```
mamba search pyjks --channel conda-forge
```
...
mamba repoquery search pyjks --channel conda-forge

# List packages depending on `pyjks`:
mamba repoquery whoneeds pyjks --channel conda-forge

# List dependencies of `pyjks`:
mamba repoquery depends pyjks --channel conda-forge
```
